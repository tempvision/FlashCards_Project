...
!(function(a) {
  ...
  a.extend(c.prototype, {
    ...
    flip: function(a) {
      if (!this.isFlipped) {
        this.isFlipped = !0;
        const b = 'rotate' + this.setting.axis;
    ...
    init: function(a) {
      ...
      const c = b.frontElement.add(b.backElement);

      const d = 'rotate' + b.setting.axis;

      const e =
        2 * b.element['outer' + ('rotatex' === d ? 'Height' : 'Width')]();

      const f = { perspective: e, position: 'relative' };
      ...
      b.setting.forceHeight
        ...
        b.backElement.css(g),
        setTimeout(function() {
          const d = b.setting.speed / 1e3 || 0.5;
    ...
    changeSettings: function(a, b) {
      ...
      if (
        ...
        const e = c.frontElement.add(c.backElement);
    ...
    (a.fn.flip = function(b, d) {
      return (
        ...
        'string' === typeof b || 'boolean' === typeof b
          ? this.each(function() {
              const c = a(this).data('flip-model');
              'toggle' === b && (b = !c.isFlipped), b ? c.flip(d) : c.unflip(d);
            })
          : this.each(function() {
              if (a(this).data('flip-model')) {
                const e = a(this).data('flip-model');
                !b ||
